...
const createPlanSchema = z.object({
  ...
  prixAnnuel: z.coerce.number().min(0).optional(),
  stripeProductId: z.string().optional(),
  stripePriceIdMensuel: z.string().optional(),
  stripePriceIdAnnuel: z.string().optional(),
  essaiJours: z.coerce.number().int().min(0).default(0),
  ordreAffichage: z.coerce.number().int().min(0).default(0),
  actif: z.boolean().default(true),
  couleur: z.string().optional(),
  modules: z.array(z.object({
    moduleCode: z.string(),
    limiteUsage: z.coerce.number().int().nullable().optional(),
...
const updatePlanSchema = z.object({
  ...
  description: z.string().optional(),
  prixMensuel: z.coerce.number().min(0).optional(),
  prixAnnuel: z.coerce.number().min(0).optional(),
  stripeProductId: z.string().optional(),
  stripePriceIdMensuel: z.string().optional(),
  stripePriceIdAnnuel: z.string().optional(),
  essaiJours: z.coerce.number().int().min(0).optional(),
  ordreAffichage: z.coerce.number().int().min(0).optional(),
