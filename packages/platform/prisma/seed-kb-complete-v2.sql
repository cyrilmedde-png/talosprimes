...
INSERT INTO agent_knowledge_entries (id, tenant_id, categorie, titre, contenu, reponse_vocale, mots_cles, actif, ordre) VALUES
...
-- ============================================================
-- CATÉGORIE : services (= modules fonctionnels)
-- ============================================================
...
-- ============================================================
-- CATÉGORIE : actions (ce que l'agent peut faire)
-- ============================================================
