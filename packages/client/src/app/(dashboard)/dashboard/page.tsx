    ...
    <div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="flex items-baseline">
                      <div className="text-2xl font-semibold text-gray-900 capitalize">{user?.role?.replace('_', ' ')}</div>
                    </dd>
                  </dl>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="flex items-baseline">
                      <div className="text-sm font-mono text-gray-600 truncate">{user?.tenantId}</div>
                    </dd>
                  </dl>
                </div>
              </div>
        ...
        <div className="bg-white shadow rounded-lg">
          <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
            <h3 className="text-lg leading-6 font-medium text-gray-900">Clients Finaux</h3>
                      ...
                      <tr key={client.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          {client.type === 'b2b' && client.raisonSociale && (
                            <div className="text-sm text-gray-500">{client.raisonSociale}</div>
                          )}
                          {client.type === 'b2c' && client.nom && client.prenom && (
                            <div className="text-sm text-gray-500">{client.prenom} {client.nom}</div>
                          )}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
